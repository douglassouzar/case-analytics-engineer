"""
Executa a query de taxa_cancelamento_outliers.sql (Q5) contra o DuckDB
local materializado pelo dbt (dbt/rentcars_analytics/dev.duckdb) e exporta
o resultado em CSV.

Uso (com o venv do projeto ativado, de qualquer pasta):
    python run_taxa_cancelamento_outliers.py
"""
...
DB_FILE = "dev.duckdb"
SQL_FILE = os.path.join(SCRIPT_DIR, "taxa_cancelamento_outliers.sql")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "results")
OUTPUT_FILE = "taxa_cancelamento_outliers.csv"
ROW_LIMIT = 1000
...
def main():
    ...
    print("Rodando taxa_cancelamento_outliers...")
