...
DB_FILE = "dev.duckdb"
SQL_FILE = os.path.join(SCRIPT_DIR, "deteccao_bot_buscas.sql")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "results")
OUTPUT_FILE = "deteccao_bot_buscas.csv"
ROW_LIMIT = 1000
...
def main():
    ...
    print("Rodando deteccao_bot_buscas...")
